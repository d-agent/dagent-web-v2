                    ...
                    <>
                        <div className="mb-6">
                            ...
                            <div className="flex gap-2 mt-3">
                                {[100, 500, 1000, 5000].map((value) => (
                                    <button
                                        key={value}
                                        onClick={() => setAmount(Math.min(value, stakedAmount).toString())}
                            ...
                            <div className="text-xs text-gray-500 mt-2">
                                Staked: <span className="text-white font-mono">{stakedAmount.toLocaleString()} ADA</span>
                            </div>
                        </div>
                        ...
                        <div className="bg-surfaceHighlight border border-white/5 rounded-xl p-4 mb-6 space-y-3">
                            ...
                            {unclaimedRewards > 0 && (
                                <div className="flex justify-between text-sm">
                                    ...
                                    <span className="font-mono text-primary">+{unclaimedRewards.toLocaleString()} ADA</span>
                                </div>
                            )}
                            <div className="flex justify-between text-sm">
                            ...
                            <div className="border-t border-white/10 pt-3 flex justify-between">
                                ...
                                <div className="text-right">
                                    <div className="font-mono font-bold text-green-400">{totalReceived.toLocaleString()} ADA</div>
                                    <div className="text-xs text-gray-500">≈ ${(totalReceived * 0.45).toFixed(2)} USD</div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div className="bg-primary/5 border border-primary/20 rounded-xl p-4 mb-6">
                                <div className="flex items-start gap-3">
                                    ...
                                    <div className="text-sm">
                                        <div className="text-primary font-medium mb-1">Rewards Included</div>
                                        <div className="text-gray-300 text-xs">
                                            Your unclaimed rewards will be automatically included in this withdrawal.
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        {numAmount > stakedAmount && (
                            <div className="bg-red-500/10 border border-red-500/20 rounded-xl p-3 mb-4 flex items-start gap-2">
                                ...
                                <p className="text-xs text-red-400">Amount exceeds staked balance. Maximum: {stakedAmount} ADA</p>
                            </div>
                        )}
